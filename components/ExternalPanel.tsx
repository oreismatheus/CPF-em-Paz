...
export const ExternalPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* 1. Citação do Dia */}
      <div className="bg-[#0a0a0a] rounded-[2rem] p-6 border border-[#1c1c1c]">
        <h4 className="text-[10px] font-black uppercase mb-3 text-slate-500">Citação do Dia</h4>
        <p className="text-base font-bold text-slate-200 leading-snug">
          "O futuro é tão brilhante quanto a sua fé."
        </p>
        <p className="text-[10px] mt-2 font-black text-[#ff3d00] uppercase">Thomas S. Monson</p>
      </div>

      {/* 2. Escritura do Dia */}
      <div className="bg-[#0a0a0a] rounded-[2rem] p-6 border border-[#1c1c1c]">
        <div className="mb-4">
          <span className="inline-block px-3 py-1 bg-[#ff3d00]/10 text-[#ff3d00] rounded-full text-[10px] font-black uppercase">Escritura do Dia</span>
        </div>
        <p className="text-slate-200 text-lg leading-relaxed mb-4 font-bold">
          "{scripture.text}"
        </p>
        <div className="text-[10px] font-black text-[#ff3d00] uppercase">{scripture.ref}</div>
      </div>

      {/* 3. Motivação do Dia */}
      <div className="bg-[#0a0a0a] rounded-[2rem] p-6 border border-[#1c1c1c]">
        <h4 className="text-[10px] font-black uppercase mb-3 text-slate-500">Motivação</h4>
      ...
      <div className="bg-[#ff3d00] rounded-[2rem] p-6 text-black shadow-2xl shadow-[#ff3d00]/20">
        <h4 className="text-[10px] font-black uppercase mb-3 opacity-70">Desafio de Evolução</h4>
